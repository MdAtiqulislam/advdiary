...
import 'package:advdiary/app/modules/archive/controllers/archive_controller.dart';
...
class ArchiveCaseListFilter extends GetView<ArchiveController> {
  const ArchiveCaseListFilter({super.key});
